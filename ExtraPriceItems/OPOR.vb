Public Class OPOR
    ...
    Public Sub addFormItems(ByVal FormUID As String)
        ...
        Try
            ...
            lsItemRef = "2"
            'lsItemRef = "2"
            '"btMov" Para que funcione primero corre este y despues el de movimientos
            loItem = coForm.Items.Add("btCost", SAPbouiCOM.BoFormItemTypes.it_BUTTON)
            loItem.Left = coForm.Items.Item(lsItemRef).Left + coForm.Items.Item(lsItemRef).Width + coForm.Items.Item(lsItemRef).Width + 40 + 10
